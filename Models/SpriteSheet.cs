...
public class SpriteSheet
{
    ...
    public void Render(GameRenderer renderer, (int X, int Y) dest, double angle = 0.0, Point rotationCenter = new(), bool uiElement = false)
    {
        if (ActiveAnimation == null)
        {
            renderer.RenderTexture(_textureId, new Rectangle<int>(0, 0, FrameWidth, FrameHeight),
                ...
                RendererFlip.None, angle, rotationCenter, uiElement);
        }
        else
        {
            ...
            renderer.RenderTexture(_textureId,
                ...
                new Rectangle<int>(dest.X - FrameCenter.OffsetX, dest.Y - FrameCenter.OffsetY, FrameWidth, FrameHeight),
                ActiveAnimation.Flip, angle, rotationCenter, uiElement);
        }
    }
}